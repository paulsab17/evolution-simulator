...
An interesting example of a single locus that can be easily seen is in the
"armor" of the threespine stickleback fish. There are several populations of this
fish, some of which have an "armor" made of bony plates along their back. This
trait has been found to be mostly controlled by a single locus, with two
different possible alleles.[^4] 
...
fluidRow(
  column(6,
         sliderInput("gens",label = "number of generations",
                     min = 50,max = 500,value = 150,step = 5,width = "auto")),
  column(6,
